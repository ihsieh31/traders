...
`tradingagents/long_run.py` owns lifecycle coordination and delegates bounded
responsibilities to `long_run_support/`. Every broker mutation still goes
through `ExecutionService`, every universe decision through Phase C screening,
